...
# 0.746 0.472   0.009903 0.01983
# 
# Using the training set, 94 variables were selected:
#   V4, V5, V7, V8, V10...
# 
# During resampling, the top 5 selected variables (out of a possible 123):
#   V10 (100%), V100 (100%), V101 (100%), V103 (100%), V106 (100%)
# 
# On average, 96.3 variables were selected (min = 91, max = 102)
